...
export const ui: Record<Locale, Translations> = {
	es: {
		...
		hero: {
			name: 'David Baque',
			introduction: [
				{ text: 'Tres años desarrollando software, combinando proyectos freelance que siguen en ' },
				{ text: 'producción', highlight: true },
				{ text: ' con experiencia profesional construyendo ' },
				{ text: 'sistemas escalables y distribuidos', highlight: true },
				{ text: ' en equipos de ingeniería. Me especializo en ' },
				{ text: 'arquitecturas limpias', highlight: true },
				{ text: ' y microservicios con ' },
				{ text: 'Go', highlight: true },
				{ text: ' y ' },
				{ text: 'TypeScript', highlight: true },
				{ text: ', manteniendo la lógica de negocio desacoplada de los detalles de infraestructura.' },
			],
	...
	en: {
		...
		hero: {
			name: 'David Baque',
			introduction: [
				{ text: 'Three years building software, combining freelance projects that remain in ' },
				{ text: 'production', highlight: true },
				{ text: ' with professional experience building ' },
				{ text: 'scalable, distributed systems', highlight: true },
				{ text: ' as part of engineering teams. I specialise in ' },
				{ text: 'clean architecture', highlight: true },
				{ text: ' and microservices with ' },
				{ text: 'Go', highlight: true },
				{ text: ' and ' },
				{ text: 'TypeScript', highlight: true },
				{ text: ', keeping business logic decoupled from infrastructure details.' },
			],
	...
	ca: {
		...
		hero: {
			name: 'David Baque',
			introduction: [
				{ text: 'Tres anys desenvolupant programari, combinant projectes freelance que continuen en ' },
				{ text: 'producció', highlight: true },
				{ text: ' amb experiència professional construint ' },
				{ text: 'sistemes escalables i distribuïts', highlight: true },
				{ text: ' en equips d’enginyeria. M’especialitzo en ' },
				{ text: 'arquitectures netes', highlight: true },
				{ text: ' i microserveis amb ' },
				{ text: 'Go', highlight: true },
				{ text: ' i ' },
				{ text: 'TypeScript', highlight: true },
				{ text: ', mantenint la lògica de negoci desacoblada dels detalls d’infraestructura.' },
			],
